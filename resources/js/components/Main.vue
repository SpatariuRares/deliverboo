...
<div>
    ...
    <div class="container">
        <div class="row">
            <div v-for="(restaurant) in dataApi.users" :key="restaurant.id" :class="restaurant.username!=null ? 'col-sm-3 col-lg-3' : null">
                <div class="p-3 d-flex"  v-if="restaurant.username!=null">
